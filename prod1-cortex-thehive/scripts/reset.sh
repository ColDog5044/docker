...
then
  ...
  DIRECTORIES="./cassandra/data ./cassandra/logs ./cortex/cortex-jobs ./cortex/logs ./elasticsearch/data ./elasticsearch/logs ./thehive/data/files ./thehive/logs"
  ...
  rm -f ./thehive/config/index.conf
  rm -f ./thehive/config/secret.conf
  rm -f ./cortex/config/index.conf
  rm -f ./cortex/config/secret.conf
