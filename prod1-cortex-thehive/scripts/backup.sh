...
## ============================================================
## BACKUP SCRIPT FOR THEHIVE & CORTEX COMBINED APPLICATION STACK
## ============================================================
## PURPOSE:
## This script creates a backup of TheHive and Cortex combined application stack, 
## including configuration, data, and logs. It is designed 
...
## - Services (Elasticsearch, Cassandra, TheHive, and Cortex) will be stopped during 
...
##
## WARNING:
## - This script stops all services, performs the backup, and then restarts the services.
