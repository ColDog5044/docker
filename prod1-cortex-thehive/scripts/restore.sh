...
## ============================================================
## RESTORE SCRIPT FOR THEHIVE & CORTEX COMBINED APPLICATION STACK
## ============================================================
## PURPOSE:
## This script restores a backup of TheHive and Cortex combined application stack, 
## including configuration, data, and logs. It is designed to 
...
##
## WARNING:
## - This script ensures all services are stopped before performing the restore, and then restarts the services.
